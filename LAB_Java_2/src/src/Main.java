...
import src.taxi.Automobile;
import src.taxi.BusTaxi;
import src.taxi.Passenger;
...
public class Main {
    ...
    static {
        ...
        try {
            fileHandler = new FileHandler("log/logManager.log");
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.printf("Количеество в коллекции: %d\n",fleet1.size());
            ...
            Fleet<Automobile> fleet2 = directorFleet.Deserialize("xml/serializeTaxi.xml");
