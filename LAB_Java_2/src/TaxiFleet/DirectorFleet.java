...
public class DirectorFleet implements Comparator<Automobile> {
    ...
    public int compare(Automobile o1, Automobile o2) {
        ...
        Double b = o1.getFuelConsumption();
        return a.compareTo(b);
    }

    public void Serialize(Fleet list) throws JAXBException, FileNotFoundException {
        //писать результат сериализации в FileOutputStream

        FileOutputStream file = new FileOutputStream("xml/serializeTaxi.xml");
